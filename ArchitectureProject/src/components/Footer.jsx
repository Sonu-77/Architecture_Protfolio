...
function Footer() {
  return (
    <div className='bg-[url("https://images.pexels.com/photos/3088778/pexels-photo-3088778.jpeg?auto=compress&cs=tinysrgb&w=800")] text-[#ffff] bg-cover sm:pt-[7vw] lg:pt-[5vw] sm:w-full sm:h-[130vw] sm:pl-[6vw] lg:pl-[18vw] lg:w-full lg:h-[30vw]'>
        <div>
        ...
        <form action="">
          ...
          <div className='sm:mt-[5vw] lg:mt-[1vw] lg:ml-0 sm:flex sm:flex-col sm:gap-[2vw] lg:gap-[0.5vw] lg:relative'>
            ...
            <input className='sm:w-[70vw] lg:w-[20vw] lg:h-[2vw] outline-dashed text-[#000000] sm:pl-[2vw] lg:pl-[1vw] ' type="email" name="email" id="email" required />
