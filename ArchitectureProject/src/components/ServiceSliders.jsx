...
function ServiceSliders() {
  ...
  return (
    <div className=' lg:w-[60vw]  sm:w-[100%] lg:mt-0 lg:mr-[10vw]  sm:mt-[5vw]'>

        <Slider {...settings}>

            <div className='lg:w-[7vw] lg:h-[18vw]  flex flex-col lg:pr-[0.5vw]' >
                <img className='lg:h-[3vw] sm:h-[16vw] lg:w-[3vw] sm:w-[16vw] sm:mb-[5vw] lg:mb-[1vw]' src="https://media.istockphoto.com/id/941867440/vector/tower-crane-icon.jpg?s=612x612&w=0&k=20&c=H5zeKPY7DZCoAPN09QDX4tJUwBD6uHsmNKpolHVSvaI=" alt="" />
